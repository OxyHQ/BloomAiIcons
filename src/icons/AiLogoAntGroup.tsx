...
/** The Ant Group mark — full colour by default, `variant="mono"` for one colour. */
export const AiLogoAntGroup = createAiLogo({
  name: "Ant Group",
  mono: ({ fill }) => (
